...
export const JAVA_SEARCH_TESTS_IN_FOLDER = 'vscode.java.test.search.folder1';

export const JAVA_SEARCH_PACKAGES_IN_FOLDER = 'vscode.java.test.search.folder';

export const JAVA_SEARCH_TESTS_CHILDREN = 'vscode.java.test.search.children';
